<?php
  $nome= exec("HOSTNAME");
  exec("ping -n 1 -w 1 -4 $nome", $output, $status);
  if (substr($output[0], 0, 19) == 'Impossibile trovare') {
    $ip='<b class="text-danger">NOME SBAGLIATO</b>';
  }else{
    switch (substr($output[2], 0, 11)) {
      ...
      case 'Risposta da':
        ...
        $ip = '<b class="text-light">'.$ipping2.'  </b>';
        $ipqr = $ipping2;
      break;
      
      default:
        $ip='<b class="text-danger">ERRORE</b>';
      break;
    }
  }
  //$ip='192.168.1.118';
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div align="center">
                    <img src="https://chart.apis.google.com/chart?cht=qr&chs=390x350&chl=http://<?php echo $ipqr;?>/" alt="Il QR Code non viene visualizzato perchè non si è connessi ad internet per utilizzare API di Google per creare il QR Code">
                  </div>
                </div>
